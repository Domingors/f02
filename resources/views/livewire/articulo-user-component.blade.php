                        ...
                        @if($artsUser != null)
                            @foreach ($artsUser as $artUser)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $artUser->precio1 }}."-".{{ $artUser->precio2 }}."-".{{ $artUser->precio3 }}."-".{{ $artUser->precio4 }}."-".{{ $artUser->precio5 }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $artUser->tramo1 }}."-".{{ $artUser->tramo2 }}."-".{{ $artUser->tramo3 }}."-".{{ $artUser->tramo4 }}."-".{{ $artUser->tramo5 }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">
